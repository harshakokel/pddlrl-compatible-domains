;; Generator input: seed=110833, locations=5, edges=5, seas=1, probabilities=[2, 3, 3, 4], goals=5, optimization=[5, 10], C=1.200000, V=1.200000
(define (problem popt-small-05-easy)
(:domain settlers)
(:objects
