;; Generator input: seed=110061, locations=5, edges=5, seas=1, probabilities=[2, 3, 3, 4], goals=5, optimization=[5, 10], C=1.200000, V=1.200000
(define (problem popt-small-05-veryeasy)
(:domain settlers)
(:objects
    p0 p1 p2 p3 p4 - place
    v0 v1 v2 - vehicle
    cl11 cl12 cl13 cl14 cl15 cl16 - coal_level
    wl11 wl12 wl13 wl14 wl15 wl16 - wood_level
    tl11 tl12 tl13 tl14 tl15 tl16 - timber_level
)
(:init
