;; Generator input: seed=90900, locations=5, edges=5, seas=1, probabilities=[2, 3, 3, 4], goals=3, optimization=[5, 10], C=1.200000, V=1.200000
(define (problem popt-small-03-easy)
(:domain settlers)
(:objects
    p0 p1 p2 p3 p4 - place
    v0 v1 v2 - vehicle
    cl11 cl12 cl13 cl14 - coal_level
    wl11 wl12 wl13 wl14 - wood_level
    tl11 tl12 tl13 tl14 - timber_level
)
(:init
