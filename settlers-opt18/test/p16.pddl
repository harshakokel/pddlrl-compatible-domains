;; Generator input: seed=100835, locations=5, edges=5, seas=1, probabilities=[2, 3, 3, 4], goals=4, optimization=[5, 10], C=1.200000, V=1.200000
(define (problem popt-small-04-veryeasy)
(:domain settlers)
(:objects
    p0 p1 p2 p3 p4 - place
    v0 v1 v2 - vehicle
    cl11 cl12 - coal_level
    wl11 wl12 - wood_level
    tl11 tl12 - timber_level
)
(:init
