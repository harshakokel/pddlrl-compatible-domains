;; Generator input: seed=20376, locations=3, edges=2, seas=0, probabilities=[2, 3, 3, 4], goals=2, optimization=[5, 10], C=1.200000, V=1.200000
(define (problem popt-tiny-02-veryeasy)
(:domain settlers)
(:objects
    p0 p1 p2 - place
    v0 v1 v2 - vehicle
