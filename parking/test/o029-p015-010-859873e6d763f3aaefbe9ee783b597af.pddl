(define   (problem parking)
  ...
  (:init
    (at-curb car_7)
    (at-curb-num car_7 curb_00)
    (behind-car car_0 car_7)
    (car-clear car_0)
    (at-curb car_6)
    (at-curb-num car_6 curb_01)
    (car-clear car_6)
    (at-curb car_3)
    ...
    (car-clear car_4)
    (at-curb car_9)
    (at-curb-num car_9 curb_04)
    (car-clear car_9)
    (at-curb car_8)
    (at-curb-num car_8 curb_05)
    (car-clear car_8)
    (at-curb car_5)
    (at-curb-num car_5 curb_06)
    (car-clear car_5)
    (at-curb car_2)
    (at-curb-num car_2 curb_07)
    (car-clear car_2)
    (at-curb car_1)
    (at-curb-num car_1 curb_08)
    (car-clear car_1)
    (curb-clear curb_09)
    (curb-clear curb_10)
    (curb-clear curb_11)
