(define (problem spider-4-1-8-6-2-500)
(:domain spider)
; Using 4 decks of cards with 1 suits per deck and 8 values per suit
;
; Deals
; deal 0: d1-s0-v3 d3-s0-v7 d1-s0-v7 d3-s0-v0 d2-s0-v6 d3-s0-v3
; deal 1: d1-s0-v4 d0-s0-v2 d0-s0-v3 d1-s0-v1 d1-s0-v6 d3-s0-v2
;
; Initial configuration of piles
; pile 0: d2-s0-v7 d3-s0-v6 d0-s0-v4 d3-s0-v5
; pile 1: d2-s0-v3 d0-s0-v1 d2-s0-v0 d3-s0-v1
; pile 2: d0-s0-v5 d3-s0-v4 d0-s0-v6
; pile 3: d0-s0-v0 d2-s0-v2 d1-s0-v5
; pile 4: d1-s0-v0 d2-s0-v4 d1-s0-v2
; pile 5: d2-s0-v5 d0-s0-v7 d2-s0-v1
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d3-s0-v6 card-d2-s0-v7)
    (on card-d0-s0-v4 card-d3-s0-v6)
    (on card-d3-s0-v5 card-d0-s0-v4)
    (on card-d2-s0-v7 pile-0)
    (clear card-d3-s0-v5)
    (part-of-tableau pile-0 pile-0)
    (part-of-tableau card-d2-s0-v7 pile-0)
    (part-of-tableau card-d3-s0-v6 pile-0)
    ...
    (on card-d0-s0-v1 card-d2-s0-v3)
    (on card-d2-s0-v0 card-d0-s0-v1)
    ...
    (on card-d2-s0-v4 card-d1-s0-v0)
    (on card-d1-s0-v2 card-d2-s0-v4)
    (on card-d1-s0-v0 pile-4)
    (clear card-d1-s0-v2)
    (part-of-tableau pile-4 pile-4)
    (part-of-tableau card-d1-s0-v0 pile-4)
    ...
    (on card-d0-s0-v7 card-d2-s0-v5)
    (on card-d2-s0-v1 card-d0-s0-v7)
    (on card-d2-s0-v5 pile-5)
    (clear card-d2-s0-v1)
    (part-of-tableau pile-5 pile-5)
    (part-of-tableau card-d2-s0-v5 pile-5)
    (part-of-tableau card-d0-s0-v7 pile-5)
    (part-of-tableau card-d2-s0-v1 pile-5)
    (movable card-d2-s0-v1)
    (in-play card-d2-s0-v5)
    (in-play card-d0-s0-v7)
    (in-play card-d2-s0-v1)
    (on card-d1-s0-v3 deal-0)
    (on card-d3-s0-v7 card-d1-s0-v3)
    (on card-d1-s0-v7 card-d3-s0-v7)
    (on card-d3-s0-v0 card-d1-s0-v7)
    (on card-d2-s0-v6 card-d3-s0-v0)
    (on card-d3-s0-v3 card-d2-s0-v6)
    (clear card-d3-s0-v3)
    (on card-d1-s0-v4 deal-1)
    (on card-d0-s0-v2 card-d1-s0-v4)
    (on card-d0-s0-v3 card-d0-s0-v2)
    (on card-d1-s0-v1 card-d0-s0-v3)
    (on card-d1-s0-v6 card-d1-s0-v1)
    (on card-d3-s0-v2 card-d1-s0-v6)
    (clear card-d3-s0-v2)
    (current-deal deal-0)
    ...
    (IS-KING card-d2-s0-v7)
    (IS-KING card-d3-s0-v7)
    (NEXT-DEAL deal-0 deal-1)
    (NEXT-DEAL deal-1 deal-2)
    (TO-DEAL card-d1-s0-v3 pile-5 deal-0 deal-0)
    (TO-DEAL card-d3-s0-v3 pile-0 deal-0 card-d2-s0-v6)
    (TO-DEAL card-d2-s0-v6 pile-1 deal-0 card-d3-s0-v0)
    (TO-DEAL card-d3-s0-v0 pile-2 deal-0 card-d1-s0-v7)
    (TO-DEAL card-d1-s0-v7 pile-3 deal-0 card-d3-s0-v7)
    (TO-DEAL card-d3-s0-v7 pile-4 deal-0 card-d1-s0-v3)
    (TO-DEAL card-d1-s0-v4 pile-5 deal-1 deal-1)
    (TO-DEAL card-d3-s0-v2 pile-0 deal-1 card-d1-s0-v6)
    (TO-DEAL card-d1-s0-v6 pile-1 deal-1 card-d1-s0-v1)
    (TO-DEAL card-d1-s0-v1 pile-2 deal-1 card-d0-s0-v3)
    (TO-DEAL card-d0-s0-v3 pile-3 deal-1 card-d0-s0-v2)
    (TO-DEAL card-d0-s0-v2 pile-4 deal-1 card-d1-s0-v4)
    (= (total-cost) 0)
)
(:goal
(and
