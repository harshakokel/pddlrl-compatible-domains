(define (problem spider-2-2-4-3-2-801)
(:domain spider)
; Using 2 decks of cards with 2 suits per deck and 4 values per suit
;
; Deals
; deal 0: d1-s1-v1 d0-s0-v0 d0-s1-v0
; deal 1: d0-s1-v3 d0-s0-v3 d1-s0-v2
;
; Initial configuration of piles
; pile 0: d1-s1-v0 d1-s0-v1 d0-s0-v2 d0-s0-v1
; pile 1: d1-s1-v3 d1-s0-v0 d1-s1-v2
; pile 2: d0-s1-v2 d1-s0-v3 d0-s1-v1
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    ...
    (on card-d1-s1-v3 pile-1)
    (clear card-d1-s1-v2)
    (part-of-tableau pile-1 pile-1)
    (part-of-tableau card-d1-s1-v3 pile-1)
    ...
    (on card-d1-s0-v3 card-d0-s1-v2)
    (on card-d0-s1-v1 card-d1-s0-v3)
    (on card-d0-s1-v2 pile-2)
    (clear card-d0-s1-v1)
    (part-of-tableau pile-2 pile-2)
    (part-of-tableau card-d0-s1-v2 pile-2)
    (part-of-tableau card-d1-s0-v3 pile-2)
    ...
    (clear card-d0-s1-v0)
    (on card-d0-s1-v3 deal-1)
    (on card-d0-s0-v3 card-d0-s1-v3)
    (on card-d1-s0-v2 card-d0-s0-v3)
    (clear card-d1-s0-v2)
    (current-deal deal-0)
    ...
    (IS-KING card-d1-s1-v3)
    (NEXT-DEAL deal-0 deal-1)
    (NEXT-DEAL deal-1 deal-2)
    (TO-DEAL card-d1-s1-v1 pile-2 deal-0 deal-0)
    (TO-DEAL card-d0-s1-v0 pile-0 deal-0 card-d0-s0-v0)
    (TO-DEAL card-d0-s0-v0 pile-1 deal-0 card-d1-s1-v1)
    (TO-DEAL card-d0-s1-v3 pile-2 deal-1 deal-1)
    (TO-DEAL card-d1-s0-v2 pile-0 deal-1 card-d0-s0-v3)
    (TO-DEAL card-d0-s0-v3 pile-1 deal-1 card-d0-s1-v3)
    (= (total-cost) 0)
)
(:goal
(and
