(define (problem spider-2-2-6-4-2-1000)
(:domain spider)
; Using 2 decks of cards with 2 suits per deck and 6 values per suit
;
; Deals
; deal 0: d1-s1-v1 d0-s1-v2 d1-s0-v2 d0-s0-v1
; deal 1: d1-s0-v1 d1-s1-v4 d0-s0-v3 d0-s1-v5
;
; Initial configuration of piles
; pile 0: d0-s0-v0 d0-s0-v4 d1-s0-v0 d1-s1-v2
; pile 1: d1-s0-v4 d0-s1-v0 d0-s0-v5 d1-s1-v5
; pile 2: d1-s1-v3 d1-s0-v5 d0-s1-v4 d0-s1-v3
; pile 3: d0-s1-v1 d0-s0-v2 d1-s0-v3 d1-s1-v0
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d0-s0-v4 card-d0-s0-v0)
    (on card-d1-s0-v0 card-d0-s0-v4)
    (on card-d1-s1-v2 card-d1-s0-v0)
    (on card-d0-s0-v0 pile-0)
    (clear card-d1-s1-v2)
    (part-of-tableau pile-0 pile-0)
    (part-of-tableau card-d0-s0-v0 pile-0)
    (part-of-tableau card-d0-s0-v4 pile-0)
    (part-of-tableau card-d1-s0-v0 pile-0)
    (part-of-tableau card-d1-s1-v2 pile-0)
    (movable card-d1-s1-v2)
    (in-play card-d0-s0-v0)
    (in-play card-d0-s0-v4)
    (in-play card-d1-s0-v0)
    (in-play card-d1-s1-v2)
    (on card-d0-s1-v0 card-d1-s0-v4)
    (on card-d0-s0-v5 card-d0-s1-v0)
    (on card-d1-s1-v5 card-d0-s0-v5)
    ...
    (part-of-tableau card-d1-s1-v5 pile-1)
    (movable card-d1-s1-v5)
    (in-play card-d1-s0-v4)
    (in-play card-d0-s1-v0)
    (in-play card-d0-s0-v5)
    (in-play card-d1-s1-v5)
    (on card-d1-s0-v5 card-d1-s1-v3)
    (on card-d0-s1-v4 card-d1-s0-v5)
    (on card-d0-s1-v3 card-d0-s1-v4)
    (on card-d1-s1-v3 pile-2)
    (clear card-d0-s1-v3)
    (part-of-tableau pile-2 pile-2)
    (part-of-tableau card-d1-s1-v3 pile-2)
    ...
    (on card-d0-s0-v2 card-d0-s1-v1)
    (on card-d1-s0-v3 card-d0-s0-v2)
    (on card-d1-s1-v0 card-d1-s0-v3)
    ...
    (part-of-tableau card-d1-s1-v0 pile-3)
    (movable card-d1-s1-v0)
    (in-play card-d0-s1-v1)
    (in-play card-d0-s0-v2)
    (in-play card-d1-s0-v3)
    (in-play card-d1-s1-v0)
    (on card-d1-s1-v1 deal-0)
    (on card-d0-s1-v2 card-d1-s1-v1)
    (on card-d1-s0-v2 card-d0-s1-v2)
    (on card-d0-s0-v1 card-d1-s0-v2)
    (clear card-d0-s0-v1)
    (on card-d1-s0-v1 deal-1)
    (on card-d1-s1-v4 card-d1-s0-v1)
    (on card-d0-s0-v3 card-d1-s1-v4)
    (on card-d0-s1-v5 card-d0-s0-v3)
    (clear card-d0-s1-v5)
    (current-deal deal-0)
    ...
    (TO-DEAL card-d1-s1-v1 pile-3 deal-0 deal-0)
    (TO-DEAL card-d0-s0-v1 pile-0 deal-0 card-d1-s0-v2)
    (TO-DEAL card-d1-s0-v2 pile-1 deal-0 card-d0-s1-v2)
    (TO-DEAL card-d0-s1-v2 pile-2 deal-0 card-d1-s1-v1)
    (TO-DEAL card-d1-s0-v1 pile-3 deal-1 deal-1)
    (TO-DEAL card-d0-s1-v5 pile-0 deal-1 card-d0-s0-v3)
    (TO-DEAL card-d0-s0-v3 pile-1 deal-1 card-d1-s1-v4)
    (TO-DEAL card-d1-s1-v4 pile-2 deal-1 card-d1-s0-v1)
    (= (total-cost) 0)
)
(:goal
(and
