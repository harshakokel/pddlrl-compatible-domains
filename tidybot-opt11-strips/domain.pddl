...
(define (domain TIDYBOT)
  ...
  (:action unpark
   ...
   :effect       (and (not (parked ?r)) (not-parked ?r))
   )

  (:action park
   :parameters (?r - robot)
   :precondition (and (not-parked ?r) (not-pushing ?r))
   :effect       (and (parked ?r) (not (not-parked ?r)))
   )
  ...
  (:action base-left
   ...
   :effect       (and (not (base-pos ?r ?cx ?y))
                      (base-pos ?r ?dx ?y)
                      (not (base-obstacle ?cx ?y)) (not-base-obstacle ?cx ?y)
                      (base-obstacle ?dx ?y) (not (not-base-obstacle ?dx ?y)))
   )
  ...
  (:action base-up
   ...
   :effect       (and (not (base-pos ?r ?x ?cy))
                      (base-pos ?r ?x ?dy)
                      (not (base-obstacle ?x ?cy)) (not-base-obstacle ?x ?cy)
                      (base-obstacle ?x ?dy) (not (not-base-obstacle ?x ?dy)))
   )
  ...
  (:action base-cart-left
   ...
   :effect       (and (not (base-pos ?r ?x1 ?y))
                      ...
                      (cart-pos ?c ?cx2 ?cy)
                      (not (base-obstacle ?x1 ?y)) (not-base-obstacle ?x1 ?y)
                      (base-obstacle ?x2 ?y) (not (not-base-obstacle ?x2 ?y))
                      (not (base-obstacle ?cx1 ?cy)) (not-base-obstacle ?cx1 ?cy)
                      (base-obstacle ?cx2 ?cy) (not (not-base-obstacle ?cx2 ?cy))))
  ...
  (:action base-cart-up
   ...
   :effect       (and (not (base-pos ?r ?x ?y1))
                      ...
                      (cart-pos ?c ?cx ?cy2)
                      (not (base-obstacle ?x ?y1)) (not-base-obstacle ?x ?y1)
                      (base-obstacle ?x ?y2) (not (not-base-obstacle ?x ?y2))
                      (not (base-obstacle ?cx ?cy2)) (not-base-obstacle ?cx ?cy2)
                      (base-obstacle ?cx ?cy2) (not (not-base-obstacle ?cx ?cy2))))
  ...
  (:action gripper-left
   ...
   :effect       (and (not (gripper-rel ?r ?cgxrel ?gyrel))
                      ...
                      (not (gripper-obstacle ?cgxabs ?gyabs)) (not-gripper-obstacle ?cgxabs ?gyabs)
                      (gripper-obstacle ?dgxabs ?gyabs) (not (not-gripper-obstacle ?dgxabs ?gyabs))))
  ...
  (:action gripper-up
   ...
   :effect       (and (not (gripper-rel ?r ?gxrel ?cgyrel))
                      ...
                      (not (gripper-obstacle ?gxabs ?cgyabs)) (not-gripper-obstacle ?gxabs ?cgyabs)
                      (gripper-obstacle ?gxabs ?dgyabs) (not (not-gripper-obstacle ?gxabs ?dgyabs)))
   )
  ...
  (:action get-left
   ...
   :effect       (and (not (object-pos ?o ?ox ?gyabs))
                      (not (gripper-obstacle ?ox ?gyabs)) (not-gripper-obstacle ?ox ?gyabs)
                      (not (gripper-empty ?r))
                      (holding ?r ?o))
   )
  ...
  (:action get-up
   ...
   :effect       (and (not (object-pos ?o ?gxabs ?oy))
                      (not (gripper-obstacle ?gxabs ?oy)) (not-gripper-obstacle ?gxabs ?oy)
                      (not (gripper-empty ?r))
                      (holding ?r ?o))
   )
  ...
  (:action put-left
   ...
   :effect       (and (not (holding ?r ?o))
                      ...
                      (gripper-obstacle ?ox ?gyabs) (not (not-gripper-obstacle ?ox ?gyabs))
                      (gripper-empty ?r)
                      )   
   )
  ...
  (:action put-up
   ...
   :effect       (and (not (holding ?r ?o))
                      ...
                      (gripper-obstacle ?gxabs ?oy) (not (not-gripper-obstacle ?gxabs ?oy))
                      (gripper-empty ?r)
                      )   
   )
